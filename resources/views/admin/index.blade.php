		...
		<div class="panel panel-container">
			<div class="row">
				@php
				 $index = 1;
				@endphp
				@foreach($data['row_1'] as $key => $value)
				@php
				 if($index==7){
				  break;
				 }
				...
				<div class="col-xs-6 col-md-3 col-lg-2 no-padding">
					<div class="panel panel-teal panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-users color-blue"></em>
							<div class="large">{{$value['jumlah_peserta']}}</div>
							<div class="text-muted">Peserta Mendaftar</div>
							<div class=""><h4>Webinar 0{{$value['webinar']}}</h4></div>
						</div>
					</div>
				</div>
				@php
